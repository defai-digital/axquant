...
WORK = Path(
    os.environ.get(
        ...
        "/Volumes/Ext4T/axquant-certification/qwen38-27b-axq-mxfp4-mtp-tier1",
    )
)
...
PACK = Path(
    os.environ.get(
        ...
        "/Volumes/Ext4T/models/AX-Qwen3.8-27B-MLX-AXQ-MXFP4-MTP",
    )
)
DATASETS = Path(
    os.environ.get(
...
def cmd_uniforms() -> None:
    ...
    source = source_bf16()
    reused = Path(
        "/Volumes/Ext4T/axquant-certification/qwen38-27b-axq-mxfp4-tier1/uniforms/uniform-mxfp4"
    )

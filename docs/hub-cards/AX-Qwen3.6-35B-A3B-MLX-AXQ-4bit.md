...
> See the [checkpoint Tier 1 certificate](https://github.com/defai-digital/axquant/blob/main/docs/certifications/qwen36-35b-axq4-nomtp-tier1.md) for the bound evidence and thresholds.
...
| Planned storage-adjusted BPW | 4.7642 |
| Measured main-model BPW | 4.8788 |
| Measured total BPW | **4.7642** |
| Safetensors weight size | 21.41 GB |
| Approximate complete download | 21.43 GB |
...
hf download AutomatosX/AX-Qwen3.6-35B-A3B-MLX-AXQ-4bit --local-dir ./AX-Qwen3.6-35B-A3B-MLX-AXQ-4bit
```

Allow at least 21.43 GB of free disk space. Pin the resulting Hub commit in reproducible
...
mlx_lm.generate \
  --model AutomatosX/AX-Qwen3.6-35B-A3B-MLX-AXQ-4bit \
...
| Release certification | **Checkpoint Tier 1 certified** on `df-macbookpro-m5` (2026-08-14), Hub commit `fc0120737e4f`; the formal AXQuant M0-M8 release campaign is a separate process and is not implied |

...
# AX-Ornith-1.5-35B-A3B-MLX-AXQ-MXFP4-MTP — 4.63 BPW measured main
...
| Property | Value |
| --- | --- |
| Base model | [ornith-ai/Ornith-1.5-35B-A3B](https://huggingface.co/ornith-ai/Ornith-1.5-35B-A3B/tree/10fbf86fed7ecee4a061f8b499a618f46001cac1) |
| Source revision | `10fbf86fed7ecee4a061f8b499a618f46001cac1` |
...
| Planned storage-adjusted BPW | 5.6026 |
| Measured main-model BPW | 4.6342 |
| Measured total BPW, including MTP | **4.9013** |
| Safetensors weight size | 22.03 GB |
| Approximate complete download | 22.05 GB |
...
| --- | --- |
| [4bit sibling](https://huggingface.co/AutomatosX/AX-Ornith-1.5-35B-A3B-MLX-AXQ-4bit-MTP) | Lower-storage AXQ budget; check its exact BPW |
| [6bit sibling](https://huggingface.co/AutomatosX/AX-Ornith-1.5-35B-A3B-MLX-AXQ-6bit-MTP) | Higher average precision near the 6-BPW budget |
...
hf download AutomatosX/AX-Ornith-1.5-35B-A3B-MLX-AXQ-MXFP4-MTP --local-dir ./AX-Ornith-1.5-35B-A3B-MLX-AXQ-MXFP4-MTP
```

Allow at least 22.05 GB of free disk space. Pin the resulting Hub commit in reproducible
...
mlx_lm.generate \
  --model AutomatosX/AX-Ornith-1.5-35B-A3B-MLX-AXQ-MXFP4-MTP \
...
- MTP sidecar: 785 tensors, 844.64M parameters, 1.69 GB, BF16.
...
the [ornith-ai/Ornith-1.5-35B-A3B model card](https://huggingface.co/ornith-ai/Ornith-1.5-35B-A3B/tree/10fbf86fed7ecee4a061f8b499a618f46001cac1) for license terms, model

...
# AX-Ornith-1.5-35B-A3B-MLX-AXQ-6bit-MTP — 6.79 BPW measured main
...
| Planned storage-adjusted BPW | 7.0053 |
| Measured main-model BPW | 6.7890 |
| Measured total BPW, including MTP | **7.0054** |
| Safetensors weight size | 31.48 GB |
| Approximate complete download | 31.50 GB |
...
hf download AutomatosX/AX-Ornith-1.5-35B-A3B-MLX-AXQ-6bit-MTP --local-dir ./AX-Ornith-1.5-35B-A3B-MLX-AXQ-6bit-MTP
```

Allow at least 31.50 GB of free disk space. Pin the resulting Hub commit in reproducible
...
mlx_lm.generate \
  --model AutomatosX/AX-Ornith-1.5-35B-A3B-MLX-AXQ-6bit-MTP \

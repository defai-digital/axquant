...
# AX-Qwen3-VL-32B-Thinking-MLX-AXQ-MXFP4 — 4.83 BPW measured main
...
| Planned storage-adjusted BPW | 5.5347 |
| Measured main-model BPW | 4.8331 |
| Measured total BPW | **4.8331** |
| Safetensors weight size | 20.15 GB |
| Approximate complete download | 20.17 GB |
...
hf download AutomatosX/AX-Qwen3-VL-32B-Thinking-MLX-AXQ-MXFP4 --local-dir ./AX-Qwen3-VL-32B-Thinking-MLX-AXQ-MXFP4
```

Allow at least 20.17 GB of free disk space. Pin the resulting Hub commit in reproducible
...
python -m mlx_vlm.generate \
  --model AutomatosX/AX-Qwen3-VL-32B-Thinking-MLX-AXQ-MXFP4 \
  --image ./image.png \

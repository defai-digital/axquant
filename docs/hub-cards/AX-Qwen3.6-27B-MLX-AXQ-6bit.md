...
> See the [checkpoint Tier 1 certificate](https://github.com/defai-digital/axquant/blob/main/docs/certifications/qwen36-27b-axq6-nomtp-tier1.md) for the bound evidence and thresholds.
...
| Property | Value |
| --- | --- |
| Base model | [Qwen/Qwen3.6-27B](https://huggingface.co/Qwen/Qwen3.6-27B/tree/6a9e13bd6fc8f0983b9b99948120bc37f49c13e9) |
...
| Planned storage-adjusted BPW | 5.7171 |
| Measured main-model BPW | 5.8058 |
| Measured total BPW | **5.7171** |
| Safetensors weight size | 19.85 GB |
| Approximate complete download | 19.88 GB |
...
| --- | --- |
| [4bit sibling](https://huggingface.co/AutomatosX/AX-Qwen3.6-27B-MLX-AXQ-4bit) | Lower-storage AXQ budget; check its exact BPW |
| [6bit sibling](https://huggingface.co/AutomatosX/AX-Qwen3.6-27B-MLX-AXQ-6bit) | Higher average precision near the 6-BPW budget |
...
Allow at least 19.88 GB of free disk space. Pin the resulting Hub commit in reproducible
...
published. The artifact records AX Engine version `6.13.5`. Native
...
| Release certification | **Checkpoint Tier 1 certified** on `df-macbookpro-m5` (2026-08-14), Hub commit `5e6421effdea`; the formal AXQuant M0-M8 release campaign is a separate process and is not implied |
...
the [Qwen/Qwen3.6-27B model card](https://huggingface.co/Qwen/Qwen3.6-27B/tree/6a9e13bd6fc8f0983b9b99948120bc37f49c13e9) for license terms, model

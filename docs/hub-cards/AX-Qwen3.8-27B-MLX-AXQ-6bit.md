...
> See the [checkpoint Tier 1 certificate](https://github.com/defai-digital/axquant/blob/main/docs/certifications/qwen38-27b-axq6-tier1.md) for the bound evidence and thresholds.
...
| Measured main-model BPW | 6.0001 |
| Measured total BPW | **6.0001** |
| Safetensors weight size | 20.52 GB |
| Approximate complete download | 20.54 GB |
...
hf download AutomatosX/AX-Qwen3.8-27B-MLX-AXQ-6bit --local-dir ./AX-Qwen3.8-27B-MLX-AXQ-6bit
```

Allow at least 20.54 GB of free disk space. Pin the resulting Hub commit in reproducible
...
mlx_lm.generate \
  --model AutomatosX/AX-Qwen3.8-27B-MLX-AXQ-6bit \
...
```bash
ax-engine serve ./AX-Qwen3.8-27B-MLX-AXQ-6bit --port 31418
```
...
| Release certification | **Checkpoint Tier 1 certified** on `df-macbookpro-m3` (2026-08-14), Hub commit `7dad544df16b`; the formal AXQuant M0-M8 release campaign is a separate process and is not implied |

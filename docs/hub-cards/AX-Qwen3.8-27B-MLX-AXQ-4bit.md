...
> See the [checkpoint Tier 1 certificate](https://github.com/defai-digital/axquant/blob/main/docs/certifications/qwen38-27b-axq4-tier1.md) for the bound evidence and thresholds.
...
| Planned storage-adjusted BPW | 5.0666 |
| Measured main-model BPW | 5.0667 |
| Measured total BPW | **5.0667** |
| Safetensors weight size | 17.33 GB |
| Approximate complete download | 17.35 GB |
...
hf download AutomatosX/AX-Qwen3.8-27B-MLX-AXQ-4bit --local-dir ./AX-Qwen3.8-27B-MLX-AXQ-4bit
```

Allow at least 17.35 GB of free disk space. Pin the resulting Hub commit in reproducible
...
mlx_lm.generate \
  --model AutomatosX/AX-Qwen3.8-27B-MLX-AXQ-4bit \
...
| Release certification | **Checkpoint Tier 1 certified** on `df-macbookpro-m3` (2026-08-14), Hub commit `9a7ace857117`; the formal AXQuant M0-M8 release campaign is a separate process and is not implied |

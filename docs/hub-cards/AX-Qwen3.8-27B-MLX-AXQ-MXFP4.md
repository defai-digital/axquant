...
# AX-Qwen3.8-27B-MLX-AXQ-MXFP4 — 4.84 BPW measured main
...
> See the [checkpoint Tier 1 certificate](https://github.com/defai-digital/axquant/blob/main/docs/certifications/qwen38-27b-axq-mxfp4-tier1.md) for the bound evidence and thresholds.
...
| Planned storage-adjusted BPW | 5.5116 |
| Measured main-model BPW | 4.8441 |
| Measured total BPW | **4.8441** |
| Safetensors weight size | 16.56 GB |
| Approximate complete download | 16.59 GB |
...
hf download AutomatosX/AX-Qwen3.8-27B-MLX-AXQ-MXFP4 --local-dir ./AX-Qwen3.8-27B-MLX-AXQ-MXFP4
```

Allow at least 16.59 GB of free disk space. Pin the resulting Hub commit in reproducible
...
mlx_lm.generate \
  --model AutomatosX/AX-Qwen3.8-27B-MLX-AXQ-MXFP4 \
...
```bash
ax-engine serve ./AX-Qwen3.8-27B-MLX-AXQ-MXFP4 --port 31418
```

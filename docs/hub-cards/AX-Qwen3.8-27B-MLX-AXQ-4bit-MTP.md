...
> See the [checkpoint Tier 1 certificate](https://github.com/defai-digital/axquant/blob/main/docs/certifications/qwen38-27b-axq4-mtp-tier1.md) for the bound evidence and thresholds.
...
| Release certification | **Checkpoint Tier 1 certified** on `df-macbookpro-m3` (2026-08-14), Hub commit `87bb18e3e3c0`; the formal AXQuant M0-M8 release campaign is a separate process and is not implied |

...
> See the [checkpoint Tier 1 certificate](https://github.com/defai-digital/axquant/blob/main/docs/certifications/ornith-35b-axq6-tier1.md) for the bound evidence and thresholds.
...
| Safetensors weight size | 26.33 GB |
| Approximate complete download | 26.35 GB |
...
Allow at least 26.35 GB of free disk space. Pin the resulting Hub commit in reproducible
...
| Release certification | **Checkpoint Tier 1 certified** on `df-macstudio-m2` (2026-08-15), Hub commit `37361076641d`; the formal AXQuant M0-M8 release campaign is a separate process and is not implied |

...
1. **Schema**
   ...
   - Update `docs/guides/schema-catalog.md` via the existing catalog renderer if that
...
5. **Docs**
   - New `docs/guides/expert-ssd-stream.md` (operator + contract).
   - Update `docs/reports/qwen38-optiq-experimental.md`: OptiQ remains the *current*
     ...
     real Qwen 3.8 pack.
   - Update `docs/guides/known-issues.md` and the Qwen 3.8 README paragraph

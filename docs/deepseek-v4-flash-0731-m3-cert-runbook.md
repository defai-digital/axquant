...
**Engine:** AX Engine **7.1.x**. Latest published release is **v7.1.3** (2026-08-19). **v7.1.4 is not tagged or released.**  
...
| --- | --- | --- | --- |
| `axq2` | `…-2bit-MTP` | `examples/deepseek-v4-experimental-2bit-v0.1.yaml` | Hub pack exists; factory 15+15 viability 0.633 on m2 |
...
Override engine when 7.1.4 exists: `AX_ENGINE_RELEASE=v7.1.4`.

...
| --- | --- | --- | --- |
| DeepSeek V4 Flash-0731 AXQ 2-bit (v1.9.0) | local convert on Studio (`axquant==1.9.0`, not Hub-published) | resident mlx-lm | Studio Ext12T `AX-DeepSeek-V4-Flash-0731-MLX-AXQ-2bit-v1.9.0` |

# Qwen3-VL-32B-Thinking MLX AXQ 6-bit — checkpoint Tier 1

**Verdict:** **not certified** on `df-macstudio-m2`.

| Field | Value |
| --- | --- |
| Hub | [`AutomatosX/AX-Qwen3-VL-32B-Thinking-MLX-AXQ-6bit`](https://huggingface.co/AutomatosX/AX-Qwen3-VL-32B-Thinking-MLX-AXQ-6bit) |
...
Machine-readable: [qwen3-vl-32b-thinking-axq6-tier1.json](qwen3-vl-32b-thinking-axq6-tier1.json).

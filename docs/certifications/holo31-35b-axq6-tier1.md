# Holo-3.1-35B-A3B MLX AXQ 6-bit — checkpoint Tier 1

**Verdict:** **not certified** on `df-macstudio-m2`.

| Field | Value |
| --- | --- |
| Hub | [`AutomatosX/AX-Holo-3.1-35B-A3B-MLX-AXQ-6bit`](https://huggingface.co/AutomatosX/AX-Holo-3.1-35B-A3B-MLX-AXQ-6bit) |
...
Machine-readable: [holo31-35b-axq6-tier1.json](holo31-35b-axq6-tier1.json).

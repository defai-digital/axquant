...
| Vision | `present-not-certified` | `true` | vision present sidecar=['vision.safetensors'] keys=['model.visual']; mlx-vlm smoke failed on df-macbookpro-m3 (Traceback (most recent call last):
  ...
  File "site-packages/mlx_vlm/generate/__main__.py). Text Tier 1 unchanged. Evidence: docs/certifications/evidence/modality-recert-capability-gated/results/qwen36-35b-axq6-nomtp-tier1.json |

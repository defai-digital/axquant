# Qwen 3.6 27B AXQ 4-bit — checkpoint Tier 1 certification

**Verdict:** certified for AXQuant checkpoint Tier 1 on 2026-08-14 for the published Hub revision.

| Field | Value |
| --- | --- |
| Hub | [`AutomatosX/AX-Qwen3.6-27B-MLX-AXQ-4bit`](https://huggingface.co/AutomatosX/AX-Qwen3.6-27B-MLX-AXQ-4bit/tree/6598b5cdcb53dbaefe26a67b1e9f0b4cf39d470a) |
| Source | `Qwen/Qwen3.6-27B@6a9e13bd6fc8f0983b9b99948120bc37f49c13e9` |
| Host | `df-macbookpro-m5` |
| Product class | `4bit` (no MTP) |
| Related MTP certificate | [qwen36-27b-axq4-tier1](qwen36-27b-axq4-tier1.md) |
...
Machine-readable: [qwen36-27b-axq4-nomtp-tier1.json](qwen36-27b-axq4-nomtp-tier1.json).
...
| Vision | `present-not-certified` | `true` | vision present sidecar=['vision.safetensors'] keys=['model.visual']; mlx-vlm smoke failed on df-macbookpro-m3 (Traceback (most recent call last):
  ...
  File "/Users/akiralam/code/axquant/.venv/lib/python3.12/site-packages/mlx_vlm/generate/__main__.py). Text Tier 1 unchanged. Evidence: /Users/akiralam/code/axquant/docs/certifications/evidence/modality-recert-capability-gated/results/qwen36-27b-axq4-nomtp-tier1.json |

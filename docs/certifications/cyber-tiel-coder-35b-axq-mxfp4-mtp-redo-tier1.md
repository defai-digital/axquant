...
192 GiB) with AXQuant 1.9.0 at `723eaeb` and AX Engine 7.5.4. Quality was
assessed and recorded; the agent-coding retention gate was not met.

Pack: [`AutomatosX/AX-Cyber-Tiel-Coder-35B-A3B-MLX-AXQ-MXFP4-MTP`](https://huggingface.co/AutomatosX/AX-Cyber-Tiel-Coder-35B-A3B-MLX-AXQ-MXFP4-MTP/tree/90b785d81d68d022945289a2bb16febe500fd314)
at `90b785d81d68d022945289a2bb16febe500fd314`. This is the same-day metadata
...
Machine-readable record: [cyber-tiel-coder-35b-axq-mxfp4-mtp-redo-tier1.json](cyber-tiel-coder-35b-axq-mxfp4-mtp-redo-tier1.json).
...
| --- | --- | --- | --- | --- | --- |
| agent-coding | 0.8333 | 0.8667 | 0.9615 | >= 0.98 | 1.4834 |
| general | 1.0000 | 1.0000 | 1.0000 | >= 0.98 | 1.7526 |

The agent-coding retention 0.9615 is below the 0.98 checkpoint threshold and the
record is therefore **Not Certified**. This is measured evidence, not an
estimate; the general suite passed at 1.0. Evidence:
[ref agent-coding](evidence/tiel-redo-20260923/cyber-tiel/quality/ref-agent-coding.json),
[cand agent-coding](evidence/tiel-redo-20260923/cyber-tiel/quality/cand-agent-coding.json),
[compare agent-coding](evidence/tiel-redo-20260923/cyber-tiel/quality/compare-agent-coding.json),
[ref general](evidence/tiel-redo-20260923/cyber-tiel/quality/ref-general.json),
[cand general](evidence/tiel-redo-20260923/cyber-tiel/quality/cand-general.json),
[compare general](evidence/tiel-redo-20260923/cyber-tiel/quality/compare-general.json).
...
[integrity receipt](evidence/tiel-redo-20260923/cyber-tiel/size/artifact-integrity.json).
...
Evidence:
[mlx-lm smoke](evidence/tiel-redo-20260923/cyber-tiel/runtime/mlx-lm-text-smoke.json),
[doctor](evidence/tiel-redo-20260923/cyber-tiel/runtime/ax-engine-doctor.json),
[bench](evidence/tiel-redo-20260923/cyber-tiel/runtime/ax-engine-bench.json),
[server response](evidence/tiel-redo-20260923/cyber-tiel/runtime/ax-engine-server-response.json).

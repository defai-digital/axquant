...
Pack: [`AutomatosX/AX-Tiel-Coder-35B-A3B-MLX-AXQ-MXFP4-MTP`](https://huggingface.co/AutomatosX/AX-Tiel-Coder-35B-A3B-MLX-AXQ-MXFP4-MTP/tree/5ab39b24bfd7f65203be9b7823b1840486f58b6d)
at `5ab39b24bfd7f65203be9b7823b1840486f58b6d`.
Machine-readable record: [tiel-coder-35b-axq-mxfp4-mtp-tier1.json](tiel-coder-35b-axq-mxfp4-mtp-tier1.json).
...
| --- | --- | --- | --- | --- | --- |
| Native bench | 32 | 47 | 68 | 10 | 0 |
| HTTP server | 32 | 49 | 71 | 9 | 0 |
...
[bench response](evidence/tiel-mxfp4-mtp-m5-20260919/tiel-bench.json), and
[server response](evidence/tiel-mxfp4-mtp-m5-20260919/tiel-server-response.json).

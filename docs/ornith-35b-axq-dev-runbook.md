...
**Claims:** **development evidence only** — not Qwen 3.6 Tier 1 / Tier 2 certification  
**Goal:** Build AutomatosX AXQ 4-bit and 6-bit MLX packs from Ornith BF16, then upload.

## Published packs (live)

| Pack | Hub repo | Product class | Measured main BPW | Hub revision |
| --- | --- | --- | --- | --- |
| 4-bit | [`AutomatosX/AX-Ornith-1.0-35B-MLX-AXQ-4bit`](https://huggingface.co/AutomatosX/AX-Ornith-1.0-35B-MLX-AXQ-4bit) | `4bit` | 4.880062 | [`d7416c665cd8ae6e5fbebc3f17bd547b78cf11fc`](https://huggingface.co/AutomatosX/AX-Ornith-1.0-35B-MLX-AXQ-4bit/tree/d7416c665cd8ae6e5fbebc3f17bd547b78cf11fc) |
| 6-bit | [`AutomatosX/AX-Ornith-1.0-35B-MLX-AXQ-6bit`](https://huggingface.co/AutomatosX/AX-Ornith-1.0-35B-MLX-AXQ-6bit) | `6bit` | 6.000062 | [`37361076641d7b7487d1b5ce1b68243ffbdbffe0`](https://huggingface.co/AutomatosX/AX-Ornith-1.0-35B-MLX-AXQ-6bit/tree/37361076641d7b7487d1b5ce1b68243ffbdbffe0) |
...
Cards must state: source id@revision, MIT attribution, development / architecture-prior scope,
vision BF16-preserved, no Qwen 3.6 Tier 1/Tier 2 claim, no MTP claim.
...
- “AXQuant development AXQ 4-bit / 6-bit MLX pack of Ornith-1.0-35B”
- “Converted with architecture-prior plan; vision preserved at BF16”
- “Runtime smoke on Apple Silicon (MLX-LM)”

**Not allowed**

- “Tier 1 / Tier 2 certified”, “Qwen 3.6 certified parity”
- Coding-bench scores without a revision-bound measured campaign
